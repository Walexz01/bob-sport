...
const Storeinfo = () => {
  return (
    ...
    {/* sold__products_cards */}
      ...
      {/* sold__products_cards */}
      <Storeinfocard className = 'ordered__products_cards' icon ={<BsBagCheckFill/> }title = 'Orders' total = '120' cost = '#12000'percentage='60' trailColor='#dde2f0' pathColor='#2d28c4' />
      {/* cancel_orders_cards */}
